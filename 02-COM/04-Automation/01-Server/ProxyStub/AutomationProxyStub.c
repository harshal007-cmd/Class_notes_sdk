...
/* 48 */	0x8,		/* FC_LONG */
	...
	/* Procedure SubtractionOfTwoIntergers */
...
/* Object interface: IMyMath, ver. 0.0,
   GUID={0x99FBF79C,0x4932,0x43E8,{0x9C,0xE5,0x44,0x99,0x0A,0xD7,0x60,0xDE}} */
...
CINTERFACE_PROXY_VTABLE(9) _IMyMathProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IMyMath::SumOfTwoIntergers */ ,
    (void *) (INT_PTR) -1 /* IMyMath::SubtractionOfTwoIntergers */
};
